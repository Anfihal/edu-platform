export default {
  ...
  scenes: [
    ...
    },
    {
      ...
      dialogues: [
        { speaker: 'Анна', text: 'Смотри, у «Хорошей страховой компании» есть страховка от невыезда. Она позволяет вернуть деньги за билеты, отель и транспорт, если поездка сорвётся по уважительной причине.' },
        ...
        { speaker: 'Анна', text: 'Страховка от невыезда не покрывает отмену самого мероприятия, только наши расходы на дорогу и проживание. Но «у Хорошей страховой компании» страхует организаторов от отмены — тогда они возвращают деньги за билеты.' }
      ],
      choices: [
    ...
    },
    {
      ...
      dialoguesAfterGame: {
        success: [
          { speaker: 'Анна', text: 'Организаторы объявили: билеты можно вернуть! У них была страховка от «Хорошей страховой компании» на случай отмены.' },
    ...
    },
    {
      ...
      dialogues: {
        withProtectionAndCancelled: [
          { speaker: 'Анна', text: 'Мы вернули деньги за поезд и гостиницу по страховке от невыезда. А организаторы вернули деньги за билеты — у них была страховка от «Хорошей страховой компании».' },
