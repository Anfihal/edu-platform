  ...
  scenes: [
    {
      ...
      dialogues: [
        ...
        { speaker: 'Максим', text: 'Ты моя самая разумная девушка. Хорошо, давай вместе посмотрим, что предлагает «Хорошая страховая компания».' }
      ],
      choices: [
    ...
    },
    {
      ...
      dialogues: [
        { speaker: 'Виктория', text: 'Смотри, у «Хорошей страховой компании» есть специальная спортивная страховка. Они покрывают даже экстремальные виды, включая маунтинбайк. Каждое третье обращение к ним по травмам связано со спортом, так что в этом они эксперты.' },
    ...
    },
    {
      ...
      dialogues: {
        withProtectionAndFall: [
          { speaker: 'Максим', text: 'Я вызываю помощь. Хорошо, что мы не пожадничали и купили страховку в «Хорошей страховой компании».' },
        ...
        withProtectionAndSuccess: [
          { speaker: 'Виктория', text: 'Это было круто! А знаешь, что ещё круче? Что у нас есть страховка от «Хорошей страховой компании» на случай, если адреналин зашкалит.' },
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          { speaker: 'Максим', text: 'Знаешь, Вик, страховка в «Хорошей страховой компании» — это круто. Но самое ценное, что у меня есть — это ты.' },
        ...
        withoutProtection: [
          { speaker: 'Максим', text: 'Я усвоил урок. Экстрим — это весело, но рисковать по-глупому — нет. В следующий раз только с полисом «Хорошаей страховой компании».' },
