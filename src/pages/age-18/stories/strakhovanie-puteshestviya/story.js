  ...
  scenes: [
    {
      ...
      dialogues: [
        ...
        { speaker: 'София', text: 'Я глянула «Хорошую страховую компанию». Полис для путешественников стоит около 3000 рублей. Покрывает и медицину, и багаж, и даже если рейс задержат. Ну что, скидываемся?' },
    ...
    },
    {
      ...
      dialogues: [
        ...
        { speaker: 'Дмитрий', text: 'Спокойно, у нас страховка. В «Хорошей страховой компании» за задержку рейса положена компенсация — до 15000 рублей. Так что бар — за их счёт.' }
      ],
      choices: [
    ...
    },
    {
      ...
      dialoguesAfterGame: {
        success: [
          ...
          { speaker: 'Дмитрий', text: 'Зато по страховке мы получим компенсацию за украденное из багажа. «Хорошей страховой компании» покрывает до 15000 рублей.' }
        ],
        fail: [
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          { speaker: 'София', text: 'Я позвонила в сервисный центр «Хорошей страховой компании». Они предоставили юриста и переводчика. Александру грозит только штраф, и тот покроет страховка.' },
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          ...
          { speaker: 'София', text: 'Всё благодаря страховке «Хорошей страховой компании». Серьёзно, лучшая инвестиция в отпуск.' },
