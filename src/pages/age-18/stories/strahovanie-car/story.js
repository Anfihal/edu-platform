    ...
    scenes: [
        ...
        },
        {
            ...
            dialogues: [
                ...
                { speaker: 'Матвей', text: 'Точно. Она вчера звонила, а я не ответил. Видимо, выследила... Вот же... Ладно, спокойно. У меня же КАСКО от "Хорошей страховой компании". Они покрывают такие случаи, как "противоправные действия третьих лиц".' },
        ...
        },
        {
            ...
            dialogues: {
                withProtection: [
                    { speaker: 'Матвей', text: 'Смотри, машину уже покрасили. Как новая! "Хорошая страховая компания всё оплатила, даже эвакуацию до сервиса. А Карине теперь светит уголовка за порчу имущества.' },
