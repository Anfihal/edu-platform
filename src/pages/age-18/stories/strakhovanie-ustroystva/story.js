  ...
  scenes: [
    {
      ...
      dialogues: [
        ...
        { speaker: 'Анна', text: 'Кстати, о рисках. Я тут глянула — у «Ингосстраха» есть полис «Мобильный». Страхует смартфоны, планшеты, ноутбуки от падений, краж, залития. Даже если сам разобьёшь — выплатят. Стоит около 10% от стоимости устройства.' }
      ],
      choices: [
        { id: 'buyInsurance', title: 'Оформить страховку', price: 3500, description: 'Защитить технику', icon: 'shield' },
    ...
    },
    {
      ...
      choices: [
        { id: 'camp', title: 'Разбить лагерь', price: 0, description: '', icon: 'camp' }
      ]
    },
    {
      id: 3,
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          { speaker: 'Мария', text: 'Так, я позвонила в «Ингосстрах». Они сказали, что падение ноутбука и кража телефона — страховые случаи. Надо будет приложить фото и заявление в полицию по краже. Выплатят по чеку, если не прошло года.' },
    ...
    },
    {
      ...
      dialogues: [
        { speaker: 'Михаил', text: 'Ну что, поход мечты превратился в финансовую катастрофу. А ведь могли просто страховку оформить.' },
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          ...
          { speaker: 'Мария', text: '«Ингосстрах» не подвёл. Всё выплатили, как обещали. Даже фотоосмотр не потребовался, когда чек есть.' },
