  ...
  scenes: [
    {
      ...
      dialogues: [
        ...
        { speaker: 'София', text: 'Кстати, о защите. Вы в курсе, что в 2025 году каждый пятый геймер сталкивался с кражей аккаунта? А мы тут целый бизнес строим. У «Хорошей страховой компании» есть полис киберстрахования для таких как мы — защита от DDoS, взломов, потери данных.' },
    ...
    },
    {
      ...
      choices: [
        { id: 'callPolice', title: 'Звонить в поддержку Хорошей страховой компании', price: 0, description: 'Воспользоваться страховкой', icon: 'police' }
      ]
    },
    {
      id: 4,
      ...
      dialogues: {
        withProtection: [
          { speaker: 'София', text: 'Я связалась с «Хорошей страховой компанией». Они подтвердили: взлом, шантаж и утечка данных — страховые случаи. Подключают юристов, технических специалистов, покроют расходы на восстановление и даже штрафы.' },
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          ...
          { speaker: 'София', text: '«Хорошей страховой компании» реально выручил. Юристы отбили претензии, технари помогли восстановить данные. Мы даже вышли в плюс по итогам месяца.' },
