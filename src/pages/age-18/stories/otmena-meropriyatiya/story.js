  ...
  scenes: [
    {
      ...
      dialogues: [
        ...
        { speaker: 'Виктория', text: '«Хорошей страховой компании» для путешественников. Она покроет отмену поездки, если что-то случится. Мы ведь уже не дети — нужно думать о таких вещах.' }
      ],
      choices: [
    ...
    },
    {
      ...
      dialogues: [
        { speaker: 'Максим', text: 'Смотри, полис от невыезда в «Хорошей страховой компании» стоит 2500 рублей. Если посвящение отменят из-за погоды или карантина, нам вернут деньги за домик и трансфер.' },
    ...
    },
    {
      ...
      dialoguesAfterGame: {
        success: [
          { speaker: 'Виктория', text: 'Спокойно. У нас есть страховка. Я звоню в «Хорошую страховую компанию».' },
    ...
    },
    {
      ...
      dialogues: {
        withProtection: [
          { speaker: 'Виктория', text: 'В «Хорошей страховой компании» сказали, что штормовое предупреждение — это страховой случай. Деньги за домик вернут в течение десяти дней.' },
